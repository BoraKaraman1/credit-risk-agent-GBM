...
func run(ctx context.Context) (*report, error) {
	...
	rep := &report{
		...
		Recommendation:  makeRecommendation(aucDrop, rankOrderBreaks, currentMetrics),
	}
...
func makeRecommendation(aucDrop float64, rankBreaks int, current map[string]float64) string {
